...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"beLeaf" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"beLeaf.sqlite"];
...
- (void)serverInterfaceInit
{
    ...
    [[_serverinterface database] cleanup];
    [_serverinterface reStartUpdateProccessing];
    [_serverinterface reStartUploadProcessing];
}
